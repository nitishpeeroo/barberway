	...
	function themerex_callback_ajax_search() {
		...
		if (!empty($s)) {
			...
			if (empty($output)) {
				...
				$output .= '<article class="post_item"><a href="#" class="post_more search_more">' . __('More results &hellip;', 'themerex') . '</a></article>';
			}
...
if (!function_exists('themerex_get_calendar')) {
    function themerex_get_calendar($onlyFirstLetter = false, $get_month = 0, $get_year = 0, $opt=array()) {
        ...
        $calendar_output = '<table id="wp-calendar-'.str_replace('.', '', mt_rand()).'" class="wp-calendar"><tfoot><tr>';
        ...
        $calendar_output .= '</th></tr>';



        $calendar_output .= '</tfoot><tbody><tr>';
        ...
        $calendar_output .= "</tr></tbody><thead><tr>";
        ...
        $calendar_output .= "</tr></thead></table>";
            ...
            <li id="comment-<?php comment_ID(); ?>" <?php comment_class('comment_item'); ?>>
                ...
                <div class="comment_content">
                    <div class="comment_info">
                        ...
                        <span class="comment_date"><span class="comment_date_label"><?php _e('Posted', 'themerex'); ?></span> <span class="comment_date_value"><?php echo get_comment_date(get_option('date_format')); ?></span></span>
