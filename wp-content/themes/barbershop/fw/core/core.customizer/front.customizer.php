...
<div id="custom_options" class="custom_options <?php echo esc_attr($co_style); ?>">
	...
	<div class="co_header">
		<div class="co_title">
			...
			<a href="#" id="co_theme_reset" class="co_reset icon-retweet-1" title="<?php _e('Reset to defaults', 'themerex'); ?>"><?php _e('RESET', 'themerex'); ?></a>
		</div>
	</div>
		...
		<div class="sc_scroll_wrapper swiper-wrapper">
			<div class="sc_scroll_slide swiper-slide">
				...
				<div class="co_section" style="display:none;">
					<div class="co_label"><?php _e('Color scheme', 'themerex'); ?></div>
				...
				<div class="co_section">
					...
					<div class="co_colorpic_list">
						<div class="iColorPicker" data-options="user_color" data-value="<?php echo esc_attr($user_color); ?>"><span><?php _e('User color', 'themerex'); ?></span></div>
					</div>
				</div>
