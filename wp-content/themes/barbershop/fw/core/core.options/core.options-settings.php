...
//					),
        'show_left_panel' => array(
                "title" => __('Show creative menu', 'themerex'),
                "desc" => __('Do you want to show creative menu?', 'themerex'),
                "override" => "category,post,page",
                "std" => "yes",
                "divider" => true,
                "options" => $THEMEREX_GLOBALS['options_params']['list_yes_no'],
            ...
            'show_traditional_menu' => array(
                "title" => __('Show traditional menu', 'themerex'),
                "desc" => __('Do you want to show traditional menu?', 'themerex'),
                "override" => "category,post,page",
                "std" => "no",
                "divider" => true,
                "options" => $THEMEREX_GLOBALS['options_params']['list_yes_no'],
            ...
            'show_appoinment_panel' => array(
                "title" => __('Show appointment panel', 'themerex'),
                "desc" => __('Do you want to show appointment panel?', 'themerex'),
                "override" => "category,post,page",
                "std" => "yes",
                "divider" => true,
                "options" => $THEMEREX_GLOBALS['options_params']['list_yes_no'],
...
//
		'body_style' => array(
					"title" => __('Body style', 'themerex'),
					"desc" => __('Select body style:<br><b>wide</b> - page fill whole window with centered content,<br><b>fullwide</b> - page content stretched on the full width of the window (with few left and right paddings),<br><b>fullscreen</b> - page content fill whole window without any paddings', 'themerex'),
					"divider" => false,
					"override" => "category,post,page",
					"std" => "wide",
...
//
		...
		'logo_align' => array(
					...
					"override" => "category,post,page",
					"std" => "center",
					"options" =>  array("center"=>__("Center", 'themerex')),
					"dir" => "horizontal",
					"type" => "checklist"
					),
...
//                    'over'  => __('Over slider', 'themerex')
		...
		"menu_responsive" => array(
					...
					"desc" => __('Allow responsive version for the main menu', 'themerex'),
					"std" => "yes",
                    "type" => "switch",
                    "options" => $THEMEREX_GLOBALS['options_params']['list_yes_no']),
