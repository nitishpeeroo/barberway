...
if (!function_exists('themerex_core_add_scripts_inline')) {
	function themerex_core_add_scripts_inline() {
		...
		echo "<script type=\"text/javascript\">"
			...
			. "THEMEREX_GLOBALS['menu_responsive']	= " . (themerex_get_theme_option('responsive_layouts') == 'yes' ? max(0, (int) themerex_get_theme_option('menu_relayout')) : 0) . ";"

	//		. "THEMEREX_GLOBALS['menu_responsive']	= " . (themerex_get_theme_option('responsive_layouts') == 'yes' ? ((int) themerex_get_theme_option('menu_relayout')) : '0') . ";"

			//. "THEMEREX_GLOBALS['menu_responsive']	= " . ('true') .";"
