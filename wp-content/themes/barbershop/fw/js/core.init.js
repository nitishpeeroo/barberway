...
jQuery(document).ready(function() {
    ...
    console.log(THEMEREX_GLOBALS['menu_responsive']);
...
function themerex_ready_actions() {
	...
	jQuery('.menu_main_nav_area ul#menu_main').clone().removeAttr('id').removeClass('menu_main_nav').addClass('menu_main_responsive').insertAfter('.menu_main_nav_area ul#menu_main');
    ...
    jQuery('.menu_main_nav_area .menu_main_responsive li a').click(function(e) {
        "use strict";
	...
	themerex_init_sfmenu('.menu_main_nav_area ul#menu_main');
    ...
    //----------------------------------------------
	jQuery('.widget_area .popup_link').addClass('inited').click(function(e){
...
function themerex_resize_actions() {
    ...
    themerex_is_creative_need(true);
...
function themerex_responsive_menu() {
	if (themerex_is_responsive_need(THEMEREX_GLOBALS['menu_responsive'])) {
		if (!jQuery('body').hasClass('responsive_menu')) {
			...
			if (jQuery('.menu_main_nav_area ul.menu_main_nav').hasClass('inited')) {
				jQuery('.menu_main_nav_area  ul.menu_main_nav').removeClass('inited').superfish('destroy');
			}
		}
	} else {
		if (jQuery('body').hasClass('responsive_menu')) {
			...
			themerex_init_sfmenu('.menu_main_nav_area ul.menu_main_nav');
    ...
    if (jQuery('body').hasClass('openMenuFix')) {
        jQuery('body').removeClass('responsive_menu');
    }
...
function themerex_is_creative_need(max_width) {
    "use strict";
    if (max_width == true) {
        jQuery('body').addClass('creative_menu');
    }
}
...
jQuery('.sidemenu_wrap .menu_main_nav li.menu-item-has-children > a').click(function (e) {
    "use strict";
