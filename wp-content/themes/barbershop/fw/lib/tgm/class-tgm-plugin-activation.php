    ...
    class TGM_Plugin_Activation {
        ...
        protected function do_plugin_install() {
            ...
            if ( isset( $_GET['plugin'] ) && ( isset( $_GET['tgmpa-install'] ) && 'install-plugin' == $_GET['tgmpa-install'] ) ) {
                ...
                $nonce = 'install-plugin_' . esc_attr($plugin['slug']);
        ...
        if ( ! class_exists( 'TGM_Bulk_Installer_Skin' ) ) {
            ...
            class TGM_Bulk_Installer_Skin extends Bulk_Upgrader_Skin {
                ...
                public function before( $title = '' ) {
                    ...
                    printf( '<h4>' . ($this->upgrader->strings['skin_before_update_header']) . ' <img alt="" src="' . admin_url( 'images/wpspin_light.gif' ) . '" class="hidden waiting-' . esc_attr($this->upgrader->update_current) . '" style="vertical-align:middle;" /></h4>', $this->plugin_names[$this->i], $this->upgrader->update_current, $this->upgrader->update_count );
