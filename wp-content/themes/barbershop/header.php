...
>
	...
	// if (themerex_get_custom_option('menu_toc_card')=='yes') echo do_shortcode( '[trx_anchor id="toc_card" title="'.__('Panier', 'themerex').'" description="'.__('{Return to Home} - |navigate to home page of the site', 'themerex').'" icon="icon-basket-1" separator="yes" url="'.card_url().'"]' ); 

	// echo '<div class="toc_item toc_separator"><div class="toc_description"><i>Return to Home</i> - <br>navigate to home page of the site</div><a href="http://leader-reader.com" class="toc_icon with_title icon-home-1"><span class="toc_title">Home</span></a></div>';
