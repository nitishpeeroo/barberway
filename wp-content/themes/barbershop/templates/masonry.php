				...
				<div class="post_content isotope_item_content">
					...
					<div class="post_descr">
						...
						if ($post_data['post_protected']) {
							...
							if (empty($post_options['readmore'])) $post_options['readmore'] = __('MORE', 'themerex');
                            ...
                            if ($show_all_counters || themerex_strpos($post_options['counters'], 'comments')!==false) {
                                ?>
                                <a class="post_counters_item post_counters_comments" title="<?php echo sprintf(__('Comments - %s', 'themerex'), $post_data['post_comments']); ?>" href="<?php echo
                            esc_url($post_data['post_comments_link']); ?>"><span class="post_counters_number icon-dialogue_text"><?php echo ($post_data['post_comments']); ?></span><span class="post_counters_number icon-dialogue_text"><?php echo ($post_data['post_comments']); ?></span></a>
                            <?php
                            }
						}
						?>
