	...
	<div class="form_wrap">
		...
		<div class="form_right">
			...
			<div class="login_socials_list sc_socials sc_socials_size_tiny">
				<?php
				$list = array(
					array('icon' => themerex_get_socials_url('facebook'), 'url'	=> '#'),
					array('icon' => themerex_get_socials_url('twitter'), 'url'	=> '#'),
					array('icon' => themerex_get_socials_url('gplus'), 'url'	=> '#')
				);
				echo trim(themerex_prepare_socials($list));
				?>
			</div>
