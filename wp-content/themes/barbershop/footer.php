			...
			?>
				<div class="copyright_wrap">
					<div class="content_wrap">
                        ...
                        <?php echo do_shortcode('[trx_socials][/trx_socials]'); ?>
					</div>
				</div>
			<?php } ?>
...
<?php
if (themerex_get_custom_option('show_left_panel')=='yes') {
    themerex_enqueue_slider();
    if (themerex_get_custom_option('show_top_panel') == 'hide') { ?>
                    ...
                    <div class="sc_scroll_slide swiper-slide">
                        <div id="popup_menu" class="popup_wrapper">
                            <nav role="navigation" class="sidemenu_area">
                                ...
                                <?php
                                if (empty($THEMEREX_GLOBALS['menu_panel'])) $THEMEREX_GLOBALS['menu_panel'] = themerex_get_nav_menu('menu_panel');
                                if (empty($THEMEREX_GLOBALS['menu_panel'])) $THEMEREX_GLOBALS['menu_panel'] = themerex_get_nav_menu();
                                echo ($THEMEREX_GLOBALS['menu_panel']);
                                ?>
                            </nav>
                            <div class="menu_contact">
                                <p class="contact">contact</p>
                                <?php dynamic_sidebar('sidebar_custom_6'); ?>
                            </div>
                        </div>
                    </div>
                </div>
...
<a href="#" class="scroll_to_top icon-angle-up" title="<?php _e('Scroll to top', 'themerex'); ?>"></a>
